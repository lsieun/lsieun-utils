...
public interface InsnProcess {
    ...
    static List<Path> getCandidateJarList(Path dirPath, int maxDepth, FilePathMatch[] filePathMatches) {
        ...
        LogicAssistant<FilePathMatch> filePathMatchLogic = LogicAssistant.of(FilePathMatch.lookup(), FilePathMatch.class);
    ...
    static void processInsn(List<Path> jarList, TextMatch[] zipEntryMatchs,
        ...
        // (1) match: zip entry
        LogicAssistant<TextMatch> textLogic = LogicAssistant.of(TextMatch.lookup(), TextMatch.class);
