...
public class MatchAsmUtils {
    ...
    static byte[] generateEnumBool(Type samType, String samMethodName, Type samMethodType, boolean flag) {
        ...
        // constructor: <init>
        {
            MethodVisitor mv = cw.visitMethod(ACC_PRIVATE,
                    CONSTRUCTOR_INTERNAL_NAME, "(Ljava/lang/String;I)V", "()V", null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
            mv.visitVarInsn(ILOAD, 2);
            mv.visitMethodInsn(INVOKESPECIAL, "java/lang/Enum", CONSTRUCTOR_INTERNAL_NAME, "(Ljava/lang/String;I)V", false);
            mv.visitInsn(RETURN);
            mv.visitMaxs(3, 3);
            mv.visitEnd();
        }
        ...
        // method: <clinit>
        {
            MethodVisitor mv = cw.visitMethod(ACC_STATIC, TYPE_INITIALIZER_INTERNAL_NAME, "()V", null, null);
            mv.visitCode();
            mv.visitTypeInsn(NEW, newClassType.getInternalName());
            mv.visitInsn(DUP);
            mv.visitLdcInsn(INSTANCE_FIELD);
            mv.visitInsn(ICONST_0);
            mv.visitMethodInsn(INVOKESPECIAL, newClassType.getInternalName(), CONSTRUCTOR_INTERNAL_NAME, "(Ljava/lang/String;I)V", false);
    ...
    static byte[] generateLogicAnd(Type samType, String samMethodName, Type samMethodType) {
        ...
        // constructor: <init>
        {
            ...
            MethodVisitor mv = cw.visitMethod(ACC_PRIVATE, CONSTRUCTOR_INTERNAL_NAME, "(Ljava/util/List;)V",
                    constructorSignature, null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", CONSTRUCTOR_INTERNAL_NAME, "()V", false);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitVarInsn(ALOAD, 1);
        ...
        // method: of
        {
            ...
            mv.visitInsn(DUP);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, newClassType.getInternalName(), CONSTRUCTOR_INTERNAL_NAME, "(Ljava/util/List;)V", false);
            mv.visitInsn(ARETURN);
            mv.visitMaxs(3, 1);
            mv.visitEnd();
        }
    ...
    static byte[] generateLogicNegate(Type samType, String samMethodName, Type samMethodType) {
        ...
        // constructor: <init>
        {
            MethodVisitor mv = cw.visitMethod(ACC_PRIVATE, CONSTRUCTOR_INTERNAL_NAME, constructorDescriptor.getDescriptor(), null, null);
            mv.visitCode();
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", CONSTRUCTOR_INTERNAL_NAME, "()V", false);
            mv.visitVarInsn(ALOAD, 0);
        ...
        // method: of
        {
            ...
            mv.visitInsn(DUP);
            mv.visitVarInsn(ALOAD, 0);
            mv.visitMethodInsn(INVOKESPECIAL, newClassType.getInternalName(), CONSTRUCTOR_INTERNAL_NAME, constructorDescriptor.getDescriptor(), false);
            mv.visitInsn(ARETURN);
            mv.visitMaxs(3, 1);
            mv.visitEnd();
        }
