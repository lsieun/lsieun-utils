package lsieun.utils.core.base;
...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    protected abstract boolean test(char character);
...
//            char[] nines = new char["0.length()];
//            for (int i = 0; i < "0.length(); i++)
//            nines[i] = (char) ("0.charAt(i) + 9);
//            return nines;
//        }
//
...
//
//        private SingleWidth() {
//            super("CharMatcher.singleWidth()", "\000
//
//                    .toCharArray(), "
//                    .toCharArray());
//        }
...
//        }
    ...
    private static final class And extends CharMatcher {
        ...
        public boolean test(char c) {
            return (this.first.test(c) && this.second.test(c));
        }
    ...
    private static final class Is extends FastMatcher {
        ...
        public CharMatcher and(CharMatcher other) {
            return other.test(this.match) ? this : none();
        }

        public CharMatcher or(CharMatcher other) {
            return other.test(this.match) ? other : super.or(other);
        }
    ...
    private static final class IsNot extends FastMatcher {
        ...
        public CharMatcher and(CharMatcher other) {
            return other.test(this.match) ? super.and(other) : other;
        }

        public CharMatcher or(CharMatcher other) {
            return other.test(this.match) ? any() : this;
        }
