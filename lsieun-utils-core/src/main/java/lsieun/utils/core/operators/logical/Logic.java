...
//
//import static lsieun.utils.core.operators.logical.LogicAsmUtils.*;
//
//
///**
// * <pre>
...
//        LogicAsmUtils.checkFunctionalInterface(samClass);
//        Class<?> clazz = getSamSubClass(lookup, samClass, MAP_OF_BOOL_TRUE, LogicAsmUtils::generateEnumTrue);
...
//        LogicAsmUtils.checkFunctionalInterface(samClass);
//        Class<?> clazz = getSamSubClass(lookup, samClass, MAP_OF_BOOL_FALSE, LogicAsmUtils::generateEnumFalse);
//        return getEnumInstance(lookup, samClass, clazz);
//    }
//
...
//        LogicAsmUtils.checkFunctionalInterface(samClass);
//        Class<?> clazz = getSamSubClass(lookup, samClass, MAP_OF_LOGIC_AND, LogicAsmUtils::generateLogicAnd);
...
//        LogicAsmUtils.checkFunctionalInterface(samClass);
//        Class<?> clazz = getSamSubClass(lookup, samClass, MAP_OF_LOGIC_OR, LogicAsmUtils::generateLogicOr);
//        return invokeFactoryMethodByList(lookup, samClass, clazz, list);
//    }
//
...
//        LogicAsmUtils.checkFunctionalInterface(samClass);
//        Class<?> clazz = getSamSubClass(lookup, samClass, MAP_OF_LOGIC_NEGATE, LogicAsmUtils::generateLogicNegate);
