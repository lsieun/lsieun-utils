package lsieun.box.shape.rect;


import lsieun.box.BoxMisc;
import lsieun.box.canvas.Canvas;
import lsieun.box.canvas.TextAlign;
import lsieun.box.shape.AbstractShape;
import lsieun.box.text.EmptyText;
import lsieun.box.text.Text;
