...
public interface OpcodeConst {
    ...
    int OPCODE_NAMES_LENGTH = OPCODE_NAMES.length;
    ...
    static String getOpcodeName(final int index) {
        return OPCODE_NAMES[index];
    }

    static short getNoOfOperands(final int index) {
        return NO_OF_OPERANDS[index];
    }

    String[] REFERENCE_KIND_NAMES = {
            "", "H_GETFIELD", "H_GETSTATIC", "H_PUTFIELD", "H_PUTSTATIC",
