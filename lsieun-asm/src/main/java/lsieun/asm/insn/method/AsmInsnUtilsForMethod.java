package lsieun.asm.insn.method;

import lsieun.asm.sample.theme.SampleForStackTrace;
...
public class AsmInsnUtilsForMethod {
    /**
     * @see SampleForStackTrace#printStackWalkerStackFrame(StackWalker.StackFrame)
     */
